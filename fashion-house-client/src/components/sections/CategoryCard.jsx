...
export default function CategoryCard({ category, index }) {
  return (
    ...
    >
      ...
      >
        <div className="flex h-28 w-28 items-center justify-center rounded-full border border-border bg-muted transition-all duration-300 group-hover:border-primary/30 group-hover:shadow-md sm:h-32 sm:w-32 overflow-hidden">
          {category.image ? (
