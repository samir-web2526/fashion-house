              ...
              <form onSubmit={handleSubmitCreate(onCreateSubmit)} className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    className={errCreate.title ? "border-red-500" : ""}
                  />
                  {errCreate.title && <p className="mt-1 text-xs text-red-500">{errCreate.title.message}</p>}
                </div>
                    ...
                    <form onSubmit={handleSubmitUpdate(onUpdateSubmit)} className="space-y-4">
                      <div>
                        ...
                        <Input
                          ...
                          className={errUpdate.title ? "border-red-500" : ""}
                        />
                        {errUpdate.title && <p className="mt-1 text-xs text-red-500">{errUpdate.title.message}</p>}
                      </div>
